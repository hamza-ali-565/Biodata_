...
const posts = [
  {
    ...
    sections: [
      ...
      {
        type: "paragraph",
        text: "The right design depends more on where the profile will be shared than on gender preference alone. For a 28-year-old software engineer in Bengaluru creating his own biodata for online matrimonial profiles: choose Modern or Sea Green Contrast — both put career and education prominently, and the clean layout reads well on phone screens. For a 25-year-old in Lucknow whose parents are creating the profile for distribution through a matrimonial bureau: Sober Blue Gold or Crimson Swirl Contrast read as formal and family-approved — the kind of design that works on a printed A4 sheet left on a relative’s table. For an NRI groom creating a profile for international sharing: Green Off-White Contrast photographs well in soft lighting and prints without losing detail.",
      },
      {
        type: "heading",
        level: 2,
      ...
      {
        type: "paragraph",
        text: "For a doctor in Chennai whose family wants the Jathagam section to be prominent: the Modern design keeps the horoscope section clean and structured — nothing is hidden, nothing competes for attention. For a Marathi girl in Pune whose family will share the profile with a local pandit: Beautiful Golden Border — it prints beautifully on glossy paper and feels traditionally appropriate without being heavy. For a girl from a Punjabi family in Delhi who wants something that stands out in a WhatsApp matrimonial group: Green Off-White Contrast has the highest contrast ratio of all our designs and gets noticed in a scrolling preview. For a software professional in Hyderabad sharing on an online platform: the Leafs Effect design is modern without looking corporate.",
      },
      {
        type: "heading",
        level: 2,
      ...
      {
        type: "paragraph",
        text: "The fastest way: answer two questions. One — is the family network traditional or modern? Two — will the profile be shared on WhatsApp or printed for in-person delivery? If traditional + WhatsApp: choose a high-contrast design with cultural elements — Crimson Swirl Contrast or Sober Blue Gold. If modern + WhatsApp: choose Modern or Sea Green Contrast — minimal layouts read best in compressed previews. If traditional + print: Beautiful Golden Border or Beautiful Traditional both print at A4 without losing ornamental detail. If modern + print: Leafs Effect or Green Border Art both hold detail at 300dpi. Browse all options and filter by community on our templates page at marriagebiodatahub.com/templates.",
      },
      {
        type: "heading",
        level: 2,
