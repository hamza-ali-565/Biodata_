...
const communityGuides = [
  ...
  { name: "Tamil Marriage Biodata", path: "/tamil-biodata-for-marriage" },
  { name: "Telugu Marriage Biodata", path: "/telugu-biodata-for-marriage" },
  { name: "Bengali Marriage Biodata", path: "/bengali-biodata-for-marriage" },
  { name: "Gujarati Marriage Biodata", path: "/gujarati-biodata-for-marriage" },
  { name: "Punjabi Marriage Biodata", path: "/punjabi-biodata-for-marriage" },
...
const freeResources = [
  ...
  { name: "Biodata Samples Gallery", path: "/biodata-samples" },
