...
const RAW_TEMPLATE_DEFINITIONS = [
  { id: "TemplateCrimsonSwirlContrast", name: "Crimson Swirl Contrast", style: "premium", description: "Deep red and cream design with traditional Indian ornamental swirls — suits Hindu and North Indian families who want a formal, distinctive look. Includes all horoscope fields.", layout: "TemplateCrimsonSwirlContrast", defaultThemeId: "maroon" },
  { id: "TemplateGreenBorderArt", name: "Green Border Art", style: "premium", description: "Decorative green border with a clean right-side photo layout — a popular choice for families in Maharashtra and South India who prefer understated elegance. Works well for both boy's and girl's biodata.", layout: "TemplateGreenBorderArt", defaultThemeId: "emerald" },
  { id: "TemplateBeautifulGoldenBorder", name: "Beautiful Golden Border", style: "premium", description: "Warm beige background with a gold ornamental border — designed for traditional Hindu and Marathi families. The golden accents read as auspicious without overwhelming the information. Prints beautifully.", layout: "TemplateBeautifulGoldenBorder", defaultThemeId: "gold" },
  { id: "TemplateLeafsEffect", name: "Leafs Effect", style: "premium", description: "Subtle green leaf artwork in the corners with an oval photo frame — suits families who want something natural and modern without being Western in feel. Good for professionals from Bengaluru, Pune, and Mumbai.", layout: "TemplateLeafsEffect", defaultThemeId: "emerald" },
  { id: "TemplateSeaGreenContrast", name: "Sea Green Contrast", style: "premium", description: "Sea-green header panel with a clean oval photo and spacious family section below — a modern format that works well for IT professionals and urban families who want simplicity over ornamentation.", layout: "TemplateSeaGreenContrast", defaultThemeId: "emerald" },
  { id: "TemplateGreenOffWhiteContrast", name: "Green Off-White Contrast", style: "premium", description: "Bold dark green header with a crisp circular photo cutout and off-white information sections — a modern, high-contrast design that photographs well and shares cleanly on WhatsApp.", layout: "TemplateGreenOffWhiteContrast", defaultThemeId: "emerald" },
  { id: "TemplateSoberBlueGold", name: "Sober Blue Gold", style: "premium", description: "Navy blue and gold — a formal, dignified design suited for families from UP, Bihar, Delhi, and Rajasthan who want a traditional, respectable presentation. Gold framing adds a formal register.", layout: "TemplateSoberBlueGold", defaultThemeId: "royal-blue" },
  { id: "TemplateBeautifulTraditional", name: "Beautiful Traditional", style: "premium", description: "Designed for Muslim families — opens with Bismillah calligraphy, features Islamic geometric arches, and includes Sect and Biradari fields. The central gold photo frame gives it a dignified, formal feel. Also used by some Sikh families who prefer the arch aesthetic.", layout: "TemplateBeautifulTraditional", defaultThemeId: "emerald" },
  { id: "TemplateModern", name: "Modern", style: "modern", description: "Minimal, clean design with the photo on the right and information left-aligned — the most popular choice for IT professionals, doctors, and MBAs in cities like Bengaluru, Pune, Hyderabad, and Mumbai. Prints in one page, shares cleanly on WhatsApp.", layout: "TemplateModern", defaultThemeId: "royal-blue" },
