...
const RAW_TEMPLATE_DEFINITIONS = [
  ...
  { id: "pavitra-patrika", slug: "pavitra-patrika", name: "Pavitra Patrika", layout: "TemplatePavitraPatrika", tag: "premium", style: "traditional", description: "Saffron patrika style with Kalash motif and lotus photo frame — crafted for traditional Hindu families in Rajasthan, MP, Gujarat, and UP who want a biodata that feels like a wedding invitation.", category: "traditional", defaultThemeId: "maroon" },
  { id: "noor-nikah", slug: "noor-nikah", name: "Noor Nikah", layout: "TemplateNoorNikah", tag: "premium", style: "traditional", description: "Bismillah in Nastaliq script, hexagonal photo, Islamic geometric star motifs — rooted in Urdu print and Hyderabadi tile tradition. For Muslim families who want more than a generic rishta biodata.", category: "traditional", defaultThemeId: "teal" },
  { id: "konkan-kiran", slug: "konkan-kiran", name: "Konkan Kiran", layout: "TemplateKonkanKiran", tag: "premium", style: "traditional", description: "Clean cross header, azulejo blue, oval portrait — the first biodata template designed for Indian Christian families. Suited for Goan Catholic, Kerala Christian, Mangalorean, and Anglo-Indian families.", category: "traditional", defaultThemeId: "navy" },
  { id: "guru-nanak", slug: "guru-nanak", name: "Guru Nanak", layout: "TemplateGuruNanak", tag: "premium", style: "traditional", description: "Ik Onkar opening, Nishan Sahib saffron and blue, Gurmukhi bilingual headings, Khanda dividers — the first biodata template built specifically for Sikh families in Punjab and the diaspora.", category: "traditional", defaultThemeId: "royal-blue" },
  { id: "vivah-varta", slug: "vivah-varta", name: "Vivah Varta", layout: "TemplateVivahVarta", tag: "premium", style: "modern", description: "Built for NRI and diaspora families — country badge, globe watermark, visa and income fields, dual currency display. The first biodata template designed to work equally well in India and abroad.", category: "modern", defaultThemeId: "navy" },
  { id: "sanskaar-saathi", slug: "sanskaar-saathi", name: "Sanskaar Saathi", layout: "TemplateSanskaarSaathi", tag: "premium", category: "traditional", defaultThemeId: "maroon", description: "Family-first biodata with khandaan crest, lineage strip, and family heritage section before individual details — crafted for joint families in UP, Bihar, Rajasthan, and Gujarat where the family's identity matters as much as the candidate's." },
  { id: "duji-vaari", slug: "duji-vaari", name: "Duji Vaari", layout: "TemplateDujiVaari", tag: "premium", category: "modern", defaultThemeId: "emerald", description: "Designed for second marriage — mature forest green palette, children field, prominent About Me, no ritual opening. For divorced and widowed adults who want a dignified, forward-looking introduction." },
  { id: "vidya-dhan", slug: "vidya-dhan", name: "Vidya Dhan", layout: "TemplateVidyaDhan", tag: "premium", category: "modern", defaultThemeId: "indigo", description: "Qualification-first layout with credential banner — designed for doctors, IAS officers, IIT/IIM graduates, and researchers where the achievement is the first impression. Education and career appear before family details." },
  { id: "ghar-dwaar", slug: "ghar-dwaar", name: "Ghar Dwaar", layout: "TemplateGharDwaar", tag: "premium", category: "traditional", defaultThemeId: "gold", description: "Block-print border, terracotta and green palette, bilingual Hindi/English field labels, native village prominent — designed for families from Tier 3 cities, small towns, and rural India who deserve a template that feels like home." },
  { id: "akhand-jodi", slug: "akhand-jodi", name: "Akhand Jodi", layout: "TemplateAkhandJodi", tag: "premium", category: "traditional", defaultThemeId: "gold", description: "Two candidates, one family, one page — the only dual biodata template in India. Brother and sister presented together under a shared family header, with their individual profiles side by side. Uses customFields for the second candidate." },
