...
export function TemplateDark({ data, theme, headingFont, bodyFont }) {
  ...
  return (
    <div
      className="relative mx-auto flex min-h-[600px] w-[450px] flex-col overflow-hidden bg-slate-900 text-slate-100 shadow-2xl "
      style={{ ...bodyStyle, }}
    >
