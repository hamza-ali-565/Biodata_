...
export function TemplateClassic({ data, theme, headingFont, bodyFont }) {
  ...
  return (
    <div
      ...
      style={{ ...bodyStyle, borderTop: `8px solid ${accent}` }}
    >
      ...
      <div className="p-8 pb-4 text-center">
        ...
        {photoDataUrl ? (
          ...
          <span className="mx-auto mb-3 block" style={{ color: accent, fontSize: "22px", lineHeight: 1 }}>❖</span>
        )}
