...
const jsonLd = [
  {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.marriagebiodatahub.com/marathi-biodata-for-marriage" },
    inLanguage: "mr-IN",
  },
  {
    "@context": "https://schema.org",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Marathi Biodata for Marriage", item: "https://www.marriagebiodatahub.com/marathi-biodata-for-marriage" },
    ],
  },
];
          ...
          <div className="mt-14 pt-8 border-t border-slate-800">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { href: "/biodata-samples", label: "See real biodata samples" },
